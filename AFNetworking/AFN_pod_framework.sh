...
PROJECT_NAME=${PWD##*/}
#动态库
#PACKAGE=$PROJECT_NAME"_SOURCE=1 pod package  ${PROJECT_NAME}.podspec --dynamic --no-mangle  --force  --spec-sources=https://github.com/CocoaPods/Specs.git"

#静态库
PACKAGE=$PROJECT_NAME"_SOURCE=1 pod package  ${PROJECT_NAME}.podspec --exclude-deps --no-mangle  --force  --spec-sources=https://github.com/CocoaPods/Specs.git"
